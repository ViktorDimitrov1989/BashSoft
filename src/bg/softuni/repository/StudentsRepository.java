...
import bg.softuni.dataStructure.SimpleOrderedList;
...
public class StudentsRepository implements Requester{
    ...
    public SimpleOrderedBag<CourseImpl> getAllCoursesSorted(Comparator<CourseImpl> cmp) {
        SimpleOrderedBag<CourseImpl> coursesSortedList = new SimpleOrderedList<CourseImpl>(CourseImpl.class, cmp);
    ...
    public SimpleOrderedBag<StudentImpl> getAllStudentsSorted(Comparator<StudentImpl> cmp) {
        SimpleOrderedBag<StudentImpl> studentsSortedList = new SimpleOrderedList<StudentImpl>(StudentImpl.class, cmp);
